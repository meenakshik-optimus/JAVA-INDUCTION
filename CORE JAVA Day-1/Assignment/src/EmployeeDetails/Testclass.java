...
public class Testclass {
	...
	public static void main(String s[]) {
		 ...
		 */
		System.out.println(" Salary of " + E1.getName() + " is "
				+ E1.calculate());
		System.out.println(" Salary of " + E2.getName() + " is "
				+ E2.calculate());
		System.out.println(" Salary of " + E3.getName() + " is "
				+ E3.calculate());
		System.out.println(" Salary of " + E4.getName() + " is "
				+ E4.calculate());

		/**
		 * counting the leave before taking the leave
		 */
		System.out.println(" Leaves left in " + E1.getName() + "'s account is "
				+ E1.countLeaves());
		 ...
		 */
		System.out.println(" Leaves left in " + E2.getName() + "'s account is "
				+ E2.countLeaves());
		...
		/**
		 * using refeernce variable of Abscalculation class but the objects are
		 * different
		 */
		GenericEmployee ab;
